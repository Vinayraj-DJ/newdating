...
//     // Search filter - ensure searchTerm is a string before calling toLowerCase
//     const normalizedSearchTerm = searchTerm && typeof searchTerm === 'string' ? searchTerm.toLowerCase() : '';
//     const matchesSearch = !normalizedSearchTerm || 
//       payout.userType?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.userId?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.coinsRequested?.toString().toLowerCase().includes(normalizedSearchTerm) ||
//       payout.amountInRupees?.toString().toLowerCase().includes(normalizedSearchTerm) ||
//       payout.payoutMethod?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.payoutDetails?.accountHolderName?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.payoutDetails?.accountNumber?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.payoutDetails?.ifsc?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.userDetails?.email?.toLowerCase()?.includes(normalizedSearchTerm) ||
//       payout.userDetails?.name?.toLowerCase()?.includes(normalizedSearchTerm);
